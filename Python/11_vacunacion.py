...
La función vacunacion deberá crear un nuevo diccionario en donde para cada departamento se contabilice el total de vacunas recibidas, siguiendo con el ejemplo Montevideo debería reflejar las 350 vacunas, Maldonado 60 y Canelones 35. 
...
def write_file(vacunation_data):
    try:
        text = "\n".join([f"{department} {vacunations}" for (department, vacunations) in vacunation_data.items()])
