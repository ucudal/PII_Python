...
print("Intercalando el archivo: {} con el archivo: {}".format(file1, file2))
print("y escribiendo el resultado en el archivo: {}".format(file3))
...
print("Intercalando el archivo: {} con el archivo: {}".format(file2, file1))
print("y escribiendo el resultado en el archivo: {}".format(file4))
